    ...
    <div className="min-h-screen flex flex-col items-center justify-start px-4 pb-20 max-w-6xl mx-auto w-full bg-black text-[#e7e9ea]">
      ...
      <main className="w-full max-w-3xl space-y-10 animate-in fade-in duration-300">
        ...
        <div className="text-center space-y-3 pt-4">
          <div className="inline-flex items-center gap-2 rounded-full bg-[#16181c] border border-[#2f3336] px-4 py-1.5 text-xs text-[#e7e9ea]">
            ...
            <span className="font-bold text-white">{formatNumber(stats.onlineVisitors)} online</span>
          ...
          <p className="text-xs sm:text-sm text-[#71767b] max-w-xl mx-auto leading-relaxed">
        ...
        <section className="rounded-3xl bg-[#16181c] border border-[#2f3336] p-6 sm:p-8 space-y-4">
          <h2 className="text-lg sm:text-xl font-black text-white tracking-tight flex items-center gap-2">
            <span className="text-amber-400 font-mono font-bold">01.</span>
            <span>How Ranking on X Works</span>
          </h2>

          <ul className="space-y-2.5 text-xs sm:text-sm text-[#e7e9ea]">
        ...
        <section className="rounded-3xl bg-[#16181c] border border-[#2f3336] p-6 sm:p-8 space-y-4">
          ...
          <ul className="space-y-2.5 text-xs sm:text-sm text-[#e7e9ea]">
            ...
            <li className="flex items-start gap-2.5">
              <XCircle className="size-4 text-red-400 shrink-0 mt-0.5" />
              <span><strong>Scam & Phishing profiles</strong> posing as impersonators are permanently banned without refund.</span>
            </li>
          </ul>
        </section>
        ...
        <div className="text-center pt-4">
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-full bg-white hover:bg-[#eff3f4] text-black font-black px-6 py-3.5 text-sm transition shadow-lg active:scale-95"
          >
